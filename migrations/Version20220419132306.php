 ...
 */
final class Version20220419132306 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN createtime DATETIME NOT NULL');
        $this->addSql('ALTER TABLE user ADD COLUMN deleted BOOLEAN NOT NULL');
    }
